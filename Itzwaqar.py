...
\033[1;91m  ♦♦♦CONTACT FACEBOOK / TWITTER @itzwaqarjatt♦♦♦
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.twitter.com/itzwaqarjatt')

    else:

        print "Wrong Username"

        os.system('xdg-open https://www.facebook.com/itzwaqarjatt')
...
\033[1;31;40m ●════════════════════════◄ Thanks To @itzwaqarjatt ►════════════════════════●
